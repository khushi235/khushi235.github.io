...
This is the project I would point at first when the question is about reliability rather
than a single answer. Before it, data quality was an opinion held separately by every
analyst on every engagement. After it, it is a number with a history, and a run either
